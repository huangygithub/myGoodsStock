...
public class ShiroAutoConfiguration {
	...
	public DefaultWebSessionManager getDefaultWebSessionManager() {
		...
		// 配置sessionManager
		sessionManager.setGlobalSessionTimeout(15 * 60 * 1000);// 15分钟
...
//		filterChainDefinitionMap.put("/login/toLogin", "logout");
		...
		// 设置拦截的路径
		if (userUlrs != null && userUlrs.length > 0) {
			for (String user : userUlrs) {
